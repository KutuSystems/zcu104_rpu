...
set orig_proj_dir "../ZCU104_RPU"

# Create project
create_project -force ZCU104_RPU ../ZCU104_RPU

# Set the directory path for the new project
set proj_dir [get_property directory [current_project]]

# Set project properties
set obj [get_projects ZCU104_RPU]
...
set_property "top" "top_ZCU104_RPU" $obj
...
add_files -fileset constrs_1 -norecurse sources/constrs_1/ZCU104_RPU.xdc
...
puts "INFO: Project created:ZCU104_RPU"
...
make_wrapper -files [get_files ZCU104_RPU.srcs/sources_1/bd/system_top/system_top.bd] -top
add_files -norecurse ZCU104_RPU.srcs/sources_1/bd/system_top/hdl/system_top_wrapper.vhd
...
update_compile_order -fileset sources_1
generate_target all [get_files  ZCU104_RPU.srcs/sources_1/bd/system_top/system_top.bd]
